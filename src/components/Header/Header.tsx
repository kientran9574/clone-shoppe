      ...
      <div className='max-w-7xl mx-auto px-4'>
              ...
              renderPopover={
                <>
                  <div className='bg-white w-full h-full rounded-md px-3 py-1'>
                    ...
                    <Link
                      to={'/'}
                      className='font-bold py-2 text-sm block px-1 hover:text-black  hover:text-opacity-55'
                    >
                      Đơn mua
                    </Link>
                    <button
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex bg-white items-center rounded-sm p-1'>
              <input
                type='text'
                placeholder='Bạn cần tìm gì cho hôm nay'
                className='text-black px-3 py-2 outline-none bg-transparent flex-grow'
                {...register('name')}
              />
              <button className='py-2 px-6 hover:opacity-90 text-center bg-orange'>
                <svg
          ...
          <div className='col-span-1 justify-self-start ml-10'>
            <Popover
              renderPopover={
                <>
                  <div className='bg-white rounded border border-gray-200 max-w-[400px] text-sm relative'>
                    <div className='p-2'>
                          ...
                          purchaseIncart.slice(0, MAX_PURCHASE).map((item) => {
                            return (
                              <div className='mt-4 flex' key={item._id}>
                                ...
                                <div className='flex-shrink-0 text-orange ml-2'>{item.product.price}</div>
                              </div>
                            )
                          })
                        ) : (
            ...
            >
              <Link to={'/'} className='relative'>
                ...
                {purchaseIncart && (
                  <span className='absolute top-[-6px] left-4 px-2 py-[1px] rounded-full bg-white text-orange text-xs'>
