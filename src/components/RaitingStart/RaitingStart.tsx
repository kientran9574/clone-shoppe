  ...
  return (
    <div className='mt-2'>
      {Array(5)
        ...
        .map((_, index) => {
          return (
            <li className='py-1 pl-2 list-none' key={index}>
              <div
                ...
                {Array(5)
                  ...
                  .map((_, indexStar) => {
                    if (indexStar < 5 - index) {
                      return (
                        <svg viewBox='0 0 9.5 8' className={activeClassname} key={indexStar}>
                          <defs>
                    ...
                    return (
                      <svg viewBox='0 0 30 30' className={nonActiveClassname} key={indexStar}>
                        <defs>
