  ...
  return (
    <div>
      <div className='flex items-center border-b border-b-gray-200 py-4 '>
        <Link
          to={'/user/profile'}
          className='h-12 w-12 rounded-full flex-shrink-0 overflow-hidden border border-black/10'
        >
          <img src={getUrlAvatar(profile?.avatar)} alt='' className='h-full w-full object-cover' />
        </Link>
        <div className='flex-grow pl-4'>
          <div className='mb-1 truncate font-semibold text-sm text-gray-600'>{profile?.email}</div>
